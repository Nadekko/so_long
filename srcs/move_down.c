...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/20 16:25:34 by andjenna          #+#    #+#             */
/*   Updated: 2024/02/22 14:41:46 by andjenna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/so_long.h"

static void	set_move_down(t_game *game, int *flag)
{
	if (game->map->map[game->player->coord.y + 1][game->player->coord.x] == 'C')
		game->coin->nb_coin--;
...
void	move_down(t_game *game)
{
	...
	if (game->map->map[game->player->coord.y + 1][game->player->coord.x] != '1')
		set_move_down(game, &flag);
}
